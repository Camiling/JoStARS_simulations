...
if(run.case1){
  ...
  save(res.1, file="extended_simulations/data/stabJGL_simulations_extended_B_1.Rdata")
}
if(run.case2){
  ...
  save(res.2, file="extended_simulations/data/stabJGL_simulations_extended_B_2.Rdata")
}
if(run.case3){
  ...
  save(res.3, file="extended_simulations/data/stabJGL_simulations_extended_B_3.Rdata")
}
if(run.case4){
  ...
  save(res.4, file="extended_simulations/data/stabJGL_simulations_extended_B_4.Rdata")
}
if(run.case5){
  ...
  save(res.5, file="extended_simulations/data/stabJGL_simulations_extended_B_5.Rdata")
}
if(run.case6){
  ...
  save(res.6, file="extended_simulations/data/stabJGL_simulations_extended_B_6.Rdata")
}

if(print.results){
  # Print results
  load("extended_simulations/data/stabJGL_simulations_extended_B_1.Rdata")
  load("extended_simulations/data/stabJGL_simulations_extended_B_2.Rdata")
  load("extended_simulations/data/stabJGL_simulations_extended_B_3.Rdata")
  load("extended_simulations/data/stabJGL_simulations_extended_B_4.Rdata")
  load("extended_simulations/data/stabJGL_simulations_extended_B_5.Rdata")
  load("extended_simulations/data/stabJGL_simulations_extended_B_6.Rdata")
  res.K4.1 = list(res.1, res.2, res.3, res.4, res.5, res.6)
  #save(res.K4.1,file="extended_simulations/data/stabJGL_simulations_extended_B.Rdata")
  load("extended_simulations/data/stabJGL_simulations_extended_B.Rdata")
  print_results_stabJGL(res.K4.1, fracs.disagreement, show.interval=F, show.sd=T, show.lambda = T, include.jointGHS = F)
}
