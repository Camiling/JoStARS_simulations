...
if(run.case1){
  ...
  set.seed(1234)
  res.1 = perform_stabJGL_simulation_orig(K,n.vals, p, N, frac.disagreement = fracs.disagreement[1], nCores = nCores, include.SSJGL = F, stars.thresh = 0.1)
...
if(run.case2){
  ...
  set.seed(1234)
  res.2 = perform_stabJGL_simulation_orig(K,n.vals, p, N, frac.disagreement = fracs.disagreement[2], nCores = nCores, include.SSJGL = F, stars.thresh = 0.1)
...
if(run.case3){
  ...
  set.seed(1234)
  res.3 = perform_stabJGL_simulation_orig(K,n.vals, p, N, frac.disagreement = fracs.disagreement[3], nCores = nCores, include.SSJGL = F, stars.thresh = 0.1)
...
if(run.case4){
  ...
  set.seed(1234)
  res.4 = perform_stabJGL_simulation_orig(K,n.vals, p, N, frac.disagreement = fracs.disagreement[4], nCores = nCores, include.SSJGL = F, stars.thresh = 0.1)
...
if(run.case5){
  ...
  set.seed(1234)
  res.5 = perform_stabJGL_simulation_orig(K,n.vals, p, N, frac.disagreement = fracs.disagreement[5], nCores = nCores, include.SSJGL = F, stars.thresh = 0.1)
...
if(run.case6){
  ...
  set.seed(1234)
  res.6 = perform_stabJGL_simulation_orig(K,n.vals, p, N, frac.disagreement = fracs.disagreement[6], nCores = nCores, include.SSJGL = F, stars.thresh = 0.1)
